...
namespace ConsoleApp1
{
    class Treangle : IComparable
    {
        ...
        public void SetArea(double treangleArea)
        {
            area = treangleArea;
        }
        ...
        {
            Treangle it = (Treangle)obj;
            if (this.GetArea() == it.GetArea()) return 0;
            else if (this.GetArea() > it.GetArea()) return 1;
            else return -1;
        }
    }
}
