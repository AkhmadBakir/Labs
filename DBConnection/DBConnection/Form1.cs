...
//        string testConnect = @"Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;User ID=akhmadbakir@outlook.com;Initial Catalog=Northwind;Data Source=(local)";
        ...
        private void connection_StateChange(object sender, System.Data.StateChangeEventArgs e)
        {
            ...
            disconnectionToolStripMenuItem.Enabled = (e.CurrentState == ConnectionState.Open);
        }
